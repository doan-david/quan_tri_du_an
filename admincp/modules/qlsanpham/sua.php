...
?>
<form method="POST" action="modules/qlsanpham/xuly.php?idsanpham=<?php echo $_GET['idsanpham']?>"  enctype="multipart/form-data">  
<tr>
    <td>Tên sản phẩm</td>
  ...
  <tr>
    ...
    <td><input type="file" value="<?php echo $row['hinhanh'] ?>" name="hinhanh">
        <img src="modules/qlsanpham/uploads/<?php echo $row['hinhanh'] ?>" width="30%"height="100px">
  </td>
  </tr>
  <tr>
    <td>Tóm tắt</td>
